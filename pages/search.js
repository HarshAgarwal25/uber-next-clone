...
const SavedPlace = tw.div`flex items-center bg-white px-4 py-2`;
const StarIcon = tw.img`bg-gray-400 w-10 h-10 p-2 rounded-full mr-2`;
const ConfirmButton = tw.div`bg-black m-2 mx-4 text-white text-center px-4 py-3 text-2xl cursor-pointer`;
